...
class MobileBottomNavigationScreen extends StatefulWidget {
  const MobileBottomNavigationScreen({super.key});

  @override
  _MobileBottomNavigationScreenState createState() =>
      _MobileBottomNavigationScreenState();
}

class _MobileBottomNavigationScreenState
    extends State<MobileBottomNavigationScreen> {
  int currentIndex = 0;
