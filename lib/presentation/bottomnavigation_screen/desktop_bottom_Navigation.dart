...
class DesktopBottomNavigationScreen extends StatefulWidget {
  const DesktopBottomNavigationScreen({super.key});

  @override
  _DesktopBottomNavigationScreenState createState() =>
      _DesktopBottomNavigationScreenState();
}

class _DesktopBottomNavigationScreenState
    extends State<DesktopBottomNavigationScreen> {
  int currentIndex = 0;
